...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Floating WhatsApp Button in bottom-left - Official Green & Tooltip */}
      <a 
      ...
      >
        <svg className="floating-wa-icon" viewBox="0 0 24 24">
          <path fill="currentColor" d="M19.005 3.175C17.252 1.42 14.927.455 12.45.455 7.423.455 3.34 4.538 3.34 9.565c0 1.605.42 3.172 1.216 4.553L2.03 22l8.06-2.114c1.34.73 2.846 1.115 4.354 1.115 5.025 0 9.111-4.086 9.111-9.113.003-2.436-.95-4.73-2.65-6.43-.01-.005-.01-.005-.01-.005zm-6.55 16.147c-1.42 0-2.812-.382-4.028-1.103l-.288-.171-4.778 1.253 1.275-4.658-.187-.297a7.514 7.514 0 0 1-1.15-4.026c.003-4.167 3.394-7.558 7.564-7.558 2.018 0 3.915.787 5.342 2.215 1.427 1.428 2.212 3.328 2.21 5.348-.006 4.17-3.398 7.56-7.568 7.56h.008zm4.148-5.666c-.227-.113-1.34-.662-1.547-.738-.208-.075-.359-.113-.51.113-.15.225-.583.737-.714.887-.132.15-.264.169-.49.056-.226-.113-.956-.352-1.82-1.123-.673-.6-1.128-1.342-1.26-1.568-.132-.226-.014-.348.099-.461.102-.102.226-.264.34-.395.113-.131.15-.225.226-.376.075-.15.038-.282-.019-.395-.056-.113-.51-1.226-.697-1.677-.183-.438-.37-.376-.51-.383-.131-.007-.282-.007-.433-.007s-.396.056-.603.282c-.207.225-.79.77-.79 1.875 0 1.105.803 2.17 1.15 2.62.345.45 1.58 2.41 3.826 3.38.535.23 1.042.4 1.378.507.537.17 1.026.146 1.411.089.43-.064 1.34-.548 1.528-1.077.188-.528.188-.98.132-1.075-.056-.095-.207-.15-.433-.263z" />
        </svg>
        <span className="wa-tooltip">Chat de Ingeniería</span>
      </a>
    </>
  );
}
